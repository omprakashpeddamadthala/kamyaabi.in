...
public class Product {
    ...
    /**
     * URL-friendly identifier derived from {@link #name}. Auto-generated by
     * {@code ProductServiceImpl} on create/update and unique across products
     * so routes like {@code /products/:slug} can look up a product without
     * exposing its database id.
     */
