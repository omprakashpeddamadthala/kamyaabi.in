...
public class ProfileController {
    ...
    @GetMapping
    @Operation(summary = "Get user profile", description = "Get the currently authenticated user's profile details including saved addresses")
    ...
    @PutMapping
    @Operation(summary = "Update user profile", description = "Update the currently authenticated user's name")
