    ...
    >
      ...
      >
        <Box component={Link} to="/admin" onClick={onNavigate} sx={{ display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
          <Box component="img" src="https://res.cloudinary.com/dsibez7to/image/upload/v1782551833/kamyaabi/assets/img/klogo1.webp" alt="Kamyaabi" sx={{ height: 36, width: 'auto' }} />
          {!collapsed && (
